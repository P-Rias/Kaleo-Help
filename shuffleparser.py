...
class PokemonData:
    def __init__(self, index):
        ...
        self.abilityindex = readbits(snippet, 2, 0, 8) #shifted it from 2 0 7 so it's accurate now.  
        self.nameindex = readbits(snippet, 6, 5, 11)
        self.growthID = readbits(snippet, 2, 7, 4)
    ...
    def printdata(self):
        #if (self.dex != 0 and self.dex !=999):   #this would work, except it doesn't just exclude the data, it adds blank spots of paragraphs.  
        if (self.classtype == 0):            
          ...
          #  print "Type Index: " + str(self.typeindex)
            ...
            if (self.apindex == 1):
                print "Base Attack Power: " + "30"
            elif (self.apindex == 2):
                print "Base Attack Power: " + "40"
            elif (self.apindex == 3):
                print "Base Attack Power: " + "50"
            elif (self.apindex == 4):
                print "Base Attack Power: " + "60"
            elif (self.apindex == 5):
                print "Base Attack Power: " + "70"
            elif (self.apindex == 6):
                print "Base Attack Power: " + "80"
            elif (self.apindex == 7):
                print "Base Attack Power: " + "90"
           ...
           # print "GrowthID: " + str(self.growthID)
           # print "AP Index: " + str(self.apindex)
